...
import { collection, query, orderBy, onSnapshot, addDoc, serverTimestamp, getDoc, doc, updateDoc, where } from 'firebase/firestore';
import { db, auth } from '../lib/firebase';
import GenZHubPaymentGate from './GenZHubPaymentGate';
import { PostDrip, UserProfile } from '../types';
import { translations } from '../lib/i18n';
import { motion, AnimatePresence } from 'motion/react';
import { ShoppingBag, Plus, Camera, X, BadgeCheck, RefreshCw, Lock, ShieldCheck, MessageSquare, TrendingUp, Sparkles, ArrowRight } from 'lucide-react';
            ...
            {filteredPosts.map((post, i) => (
              ...
              >
                <div className="relative aspect-[4/5] overflow-hidden">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-xl px-3 py-1.5 rounded-full border border-white/10">
